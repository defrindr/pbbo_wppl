...
class PosttestController extends Controller
{
    ...
    private function selesai($unique_id)
    {
        ...
        $pelatihan_jenis_soal = PelatihanSoalJenis::findOne(['pelatihan_id' => $pelatihan->id, 'jenis_id' => Constant::SOAL_JENIS_POSTTEST]);
        ...
        $peserta->nilai_posttest = $nilai_akhir;
    ...
    public function actionPostAnswer()
    {
        ...
        if (count($jawabans) > 0) {
            foreach ($jawabans as $unique_id => $jawaban) {
                ...
                $pelatihan_soal_jenis = PelatihanSoalJenis::findOne(['id' => $pelatihan_soal->jenis_id, 'jenis_id' => Constant::SOAL_JENIS_POSTTEST]);
    ...
    public function actionRequestSoal($id, $unique_id)
    {
        ...
        $pelatihan_soal_jenis = PelatihanSoalJenis::findOne(['pelatihan_id' => $pelatihan->id, 'jenis_id' => Constant::SOAL_JENIS_POSTTEST]);
        if ($pelatihan_soal_jenis == null) {
            return $this->renderPartial('not-found');
        }
    ...
    public function actionIndex($unique_id = null)
    {
        ...
        $model_jenis_soal = $model->getPelatihanSoalJenis()->where(['jenis_id' => Constant::SOAL_JENIS_POSTTEST])->one();
        if ($model_jenis_soal == []) {
            return $this->render('not-found', [
