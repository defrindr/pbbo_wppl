...
/**
 * This is the base-model class for table "pelatihan_kuesioner_kepuasan".
 *
 * @property integer $id
 ...
 * @property \app\models\MasterKuesionerKepuasan $soal0
 * @property \app\models\PelatihanSoalJenis $jenis
 * @property string $aliasModel
 */
abstract class PelatihanKuesionerKepuasan extends \yii\db\ActiveRecord
{
    ...
    {
        return 'pelatihan_kuesioner_kepuasan';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['soal'], 'exist', 'skipOnError' => true, 'targetClass' => \app\models\MasterKuesionerKepuasan::className(), 'targetAttribute' => ['soal' => 'id']],
    ...
    {
        return $this->hasOne(\app\models\MasterKuesionerKepuasan::className(), ['id' => 'soal']);
    }
